...
export interface Collection1155V2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface Collection1155V2 extends BaseContract {
  connect(runner?: ContractRunner | null): Collection1155V2;
  waitForDeployment(): Promise<this>;

  interface: Collection1155V2Interface;
  ...
  batchBurn: TypedContractMethod<
    [ids: BigNumberish[], values: BigNumberish[]],
    [void],
    "nonpayable"
  >;
  ...
  initialize: TypedContractMethod<
    [owner: AddressLike, _name: string, _symbol: string],
    [void],
    "nonpayable"
  >;
  ...
  mintWithUri: TypedContractMethod<
    [to: AddressLike, id: BigNumberish, value: BigNumberish, newuri: string],
    [bigint],
    "nonpayable"
  >;
