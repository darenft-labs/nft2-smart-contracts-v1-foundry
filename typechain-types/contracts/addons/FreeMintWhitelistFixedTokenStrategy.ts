...
export interface FreeMintWhitelistFixedTokenStrategyInterface
  extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
...
export interface FreeMintWhitelistFixedTokenStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): FreeMintWhitelistFixedTokenStrategy;
  waitForDeployment(): Promise<this>;

  interface: FreeMintWhitelistFixedTokenStrategyInterface;
