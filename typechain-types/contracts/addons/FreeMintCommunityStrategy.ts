...
export interface FreeMintCommunityStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "campaignId"
  ...
  encodeFunctionData(
    functionFragment: "maxAllocation",
    values?: undefined
  ): string;
...
export interface FreeMintCommunityStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): FreeMintCommunityStrategy;
  waitForDeployment(): Promise<this>;

  interface: FreeMintCommunityStrategyInterface;
  ...
  maxAllocation: TypedContractMethod<[], [bigint], "view">;
