...
export interface FreeMintWhitelistAbstractContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "campaignId"
...
export interface FreeMintWhitelistAbstractContract extends BaseContract {
  connect(runner?: ContractRunner | null): FreeMintWhitelistAbstractContract;
  waitForDeployment(): Promise<this>;

  interface: FreeMintWhitelistAbstractContractInterface;
